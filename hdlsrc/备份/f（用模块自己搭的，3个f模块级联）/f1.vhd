...
ARCHITECTURE rtl OF f1 IS
  ...
  FOR ALL : MinMax_block
    USE ENTITY work.MinMax_block(rtl);
...
BEGIN
  ...
  Logical_Operator_out1 <= Extract_Bits_out1_is_not0 AND Extract_Bits1_out1_is_not0;
