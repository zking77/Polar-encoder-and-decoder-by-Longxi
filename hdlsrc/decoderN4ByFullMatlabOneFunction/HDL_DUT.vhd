-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\decoderN4ByFullMatlabOneFunction\HDL_DUT.vhd
...
-- 
-- Module: HDL_DUT
-- Source Path: decoderN4ByFullMatlabOneFunction/HDL_DUT
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF HDL_DUT IS
  ...
  SIGNAL u2                               : std_logic;
  SIGNAL u3                               : std_logic;
  SIGNAL u4                               : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL soft1                            : std_logic_vector(7 DOWNTO 0);  -- ufix8
